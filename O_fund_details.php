        ...
        <div class="FundList">
            ...
            <div style="display:flex; align-items:center;justify-content:space-between;">
                <form action="" method="POST" enctype="multipart/form-data" style="width: 50%;">
                    ...
                    <div class="form_row">
                        ...
                        <input type="number" name="amount" placeholder="<?php echo $fund['received'] ?> / <?php echo $fund['amount'] ?>" disabled>
                    </div>
                    <div class="form_row">
                ...
                <img src="./assets/<?php echo $fund['img'] ?>" style="width:450px; height:250px; border-radius:15px;">
            </div>
            <section class="table__body">
                <table>
                    ...
                    <tbody>
                        <?php include "./O_fund_fetch_selected_BE.php" ?>
                    </tbody>
                </table>
            </section>
        </div>
