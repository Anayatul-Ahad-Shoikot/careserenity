document.addEventListener("DOMContentLoaded", () => {
    // Initial function calls to set up click listeners and fetch the initial inbox list
    addClickListenersToInboxList();
    // Check if outId and inId are set and load the chat directly
    if (outId && inId) {
    loadChat(outId, inId);
    }
});
...
setInterval(fetchInboxList, 5000);