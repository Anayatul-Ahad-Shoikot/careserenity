<?php
        ...
        $org_id = $_GET['org_id'];
        $sql = "SELECT funds.*, org_list.org_name FROM funds LEFT JOIN org_list ON funds.org_id = org_list.org_id WHERE funds.fund_id = ?";
        ...
        <div class="popup-content">
            ...
            <div class="wrapper">
                ...
                <form action="./fund_donation_submit_BE.php" method="POST">
                    ...
                    <div class="input_group">
                        <div class="input_box">
                            <button type="submit" name="fund_donate_loggedout" id="button-30">Donate</button>
                        </div>
                    </div>
                </form>
            </div>
