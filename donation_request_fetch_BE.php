...
$query3 = "SELECT SUM(amount) AS total_amount_received FROM donations WHERE receiver_id = $org_id_current";
...
$query4 = "SELECT ul.user_id, ul.user_name, orl.first_name, orl.last_name, d.amount, d.receiver_type FROM donations AS d
                ...
                LEFT JOIN orphan_list AS orl ON d.receiver_orphan_id = orl.orphan_id
